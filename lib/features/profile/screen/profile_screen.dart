...
//                   end: Alignment.bottomCenter,
//                   colors: [
//                     AppColors.xorangeColor.withValues(alpha: 0.25),
...
//               diameter: 200,
//               colors: [
//                 AppColors.darkAccentColor.withValues(alpha: 0.18),
//                 AppColors.xorangeColor.withValues(alpha: 0.06),
//               ],
//             ),
//           ),
//           Positioned(
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [
            Colors.white,
            AppColors.xbackgroundColor3.withValues(alpha: 0.5),
          ],
        ),
        border: Border.all(color: AppColors.greyE5),
        boxShadow: [
...
//         boxShadow: [
//           BoxShadow(
//             color: AppColors.darkAccentColor.withValues(alpha: 0.35),
//             blurRadius: 22,
...
//         gradient: LinearGradient(
//           colors: [
//             AppColors.darkAccentColor.withValues(alpha: 0.9),
//             AppColors.xorangeColor,
//           ],
//         ),
//         boxShadow: [
//           BoxShadow(
//             color: AppColors.darkAccentColor.withValues(alpha: 0.24),
//             blurRadius: 18,
//             offset: const Offset(0, 10),
//           ),
//         ],
