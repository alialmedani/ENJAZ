...
import 'package:enjaz/core/ui/widgets/general_error_widget.dart';
import 'package:enjaz/core/ui/widgets/no_data_screen.dart';
          ...
          if (state is Loading) {
            return Center(
                child: LoadingWidget(
                    ...
                    highlightColor: widget.highlightColor ?? AppColors.grey3B));
          } else if (state is GetListSuccessfully) {
